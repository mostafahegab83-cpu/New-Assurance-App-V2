...
(function () {
  ...
  document.querySelectorAll(".tab").forEach(tab => {
    tab.addEventListener("click", () => {
      ...
      if (tab.dataset.tab === "riskDashboard") renderDashboard();
  ...
  async function exportPdf() {
    ...
    try {
      ...
      let orderedBlocks;
      if (scope === "all") {
        orderedBlocks = [header, kpis, scheduleVar, taskCard, complianceRow, capaRow, riskRow, findings];
      } else {
        ...
        if (scope === "charts") orderedBlocks.push(taskCard, complianceRow, capaRow, riskRow);
