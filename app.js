...
(function () {
  ...
  function renderDashboard() {
    ...
    const CAT_NC_REASON   = { labels:["Missing Evidence","Missing Ticket Resolution","Incomplete Forms",
                                      "Missing Signatures or Approvals","Unapproved Documents Used",
                                      "Outdated SOPs","Version Control Problems","SLA Breach"],
                              colors:["#dc2626","#d97706","#2563eb","#7c3aed","#06b6d4","#16a34a","#db2777","#f59e0b"] };
