...
(function () {
  ...
  /* ---------- Filters & Dashboard ---------- */
  const FILTER_IDS = ["filterDept","filterDepartment","filterProcess","filterProcessOwner","filterCompliance","filterRiskLevel","filterMitigation"];
  ...
  function exportCSV() {
    const anyFilter = !!document.getElementById("filterSearch").value
      || ["filterDept","filterDepartment","filterProcess","filterProcessOwner","filterCompliance","filterRiskLevel","filterMitigation"].some(id => msValues(id).length);
