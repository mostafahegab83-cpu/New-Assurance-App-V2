...
(function () {
  ...
  // Vibrant, diverse palette for donut/pie charts so slices are visually distinct
  const DONUT_PALETTE = [
    "#2563eb","#16a34a","#f59e0b","#dc2626","#7c3aed",
    "#0891b2","#ea580c","#db2777","#0d9488","#a16207",
    "#4f46e5","#65a30d","#b91c1c","#c026d3","#0369a1",
    "#facc15","#14b8a6","#f472b6","#8b5cf6","#22c55e"
  ];
  ...
  function render() {
    ...
    const insights = [
      `${pct2plus}% (${shared2plus}) of processes are shared by 2 or more companies.`,
  ...
  async function exportPdf() {
    const node = $("piDash"); if (!node) return;
    const btn = $("pidExportPdf");
    ...
    try {
      ...
      pdf.save(`Process_Inventory_Dashboard_${stamp}.pdf`);
    } catch (e) {
      console.error(e); alert("Failed to export PDF: " + (e?.message || e));
    } finally {
