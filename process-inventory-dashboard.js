...
(function () {
  ...
  function exportCsv() {
    ...
    downloadBlob(new Blob(["\uFEFF"+csv], { type: "text/csv;charset=utf-8;" }),
      `Process-Inventory-Dashboard-${stamp}.csv`);
  }
  ...
  function exportExcel() {
    ...
    const stamp = new Date().toISOString().slice(0,10);
    XLSX.writeFile(wb, `Process-Inventory-Dashboard-${stamp}.xlsx`);
  }
  ...
  function boot() {
    ...
    $("pidExportCsv")?.addEventListener("click", exportCsv);
    $("pidExportExcel")?.addEventListener("click", exportExcel);
