...
const authInstance = auth
  || safeCall(() => typeof firebase.getAuth === "function" ? firebase.getAuth() : null)
  || safeCall(() => typeof firebase.auth === "function" ? firebase.auth() : null)
  || (firebase.auth && typeof firebase.auth === "object" ? firebase.auth : null);
...
(function () {
  ...
  async function exportPdf() {
    ...
    try { drawTaskPerformanceDonut("chartTaskPerformance", getFiltered()); } catch (_) {}
